...
#define SRCLK             _PB1
#define RCLK              _PB2
#define _GPIO_UNUSED_4    _PB3
#define _GPIO_UNUSED_5    _PB4
#define _GPIO_UNUSED_6    _PB5
#define _GPIO_UNUSED_7    _PB6
#define _GPIO_UNUSED_8    _PB7

#define _GPIO_UNUSED_9    _PC0
