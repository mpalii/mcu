/*
 * Multitasking, example of asynchronous execution using simplest round robin scheduler
 ...
 *
 * IT IS IMPORTANT! All frequencies in this example are approximations
 *
 * Created: 11/02/2023 12:32:59
 * Author : Maksym Palii
 */ 
