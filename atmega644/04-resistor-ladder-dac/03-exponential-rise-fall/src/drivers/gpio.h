...
void init_gpio(void)
{
    ...
    GPIO_SET_OUTPUT(DAC0);
    GPIO_SET_OUTPUT(DAC1);
    GPIO_SET_OUTPUT(DAC2);
    GPIO_SET_OUTPUT(DAC3);
    GPIO_SET_OUTPUT(DAC4);
    GPIO_SET_OUTPUT(DAC5);
    GPIO_SET_OUTPUT(DAC6);
    GPIO_SET_OUTPUT(DAC7);
